...
<style>
    ...
    div.col-md-9 {
        min-width: 100% !important; /* Esto también puede ayudar a evitar restricciones */
    }  
}
    ...
    <ul class="navbar-nav ms-auto mt-2">
        ...
        <li class="nav-item dropdown d-flex align-items-center" ondragstart="return false;">
            ...
            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                ...
                @else
                <img src="https://fastly.picsum.photos/id/553/300/300.jpg?hmac=WE9FKJk4612U2gMl9W5K_2M4hVaqFL-Vg7Q7uCspY2A" alt="{{ Auth::user()->name }}" class="rounded-circle border" style="width: 80px; height: 80px; margin-left: 8px; border: 2px solid #ddd;">
                @endif
                <!--nombre perfil-->
