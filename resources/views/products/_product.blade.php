    ...
    <div id="dsa" class="card-body">
      ...
      <div class="row">
        <div class="btn-group d-flex justify-content-end" role="group" aria-label="Basic example">
          <button id="btnProduct" wire:click="addToCart({{ $product }})" class="btn btn-primary" data-tooltip="Agregar al carrito." onclick="showNotification()">
          ...
          @if (auth()->user()->isAdmin())
            <a id="btnProduct" href="{{ route('products.edit', ['product' => $product]) }}" class="btn btn-warning" data-tooltip="Editar Producto.">
            ...
            <button id="btnProduct" type="submit" form="deleteProductForm" class="btn btn-danger" data-tooltip="Eliminar Producto.">
