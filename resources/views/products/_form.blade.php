...
<div class="mb-3">
  ...
  @error('name') <p style="color: red;"></p> @enderror
</div>

<div class="mb-3">
  <label for="description" class="form-label">Description:</label>
  <textarea name="description" class="form-control">{{ old('description', $product->description) }}</textarea>
  @error('description') <p style="color: red;"></p> @enderror
</div>
...
<div class="mb-3">
  ...
  @error('category_id') <p style="color: red;"></p> @enderror
</div>
...
<div class="mb-3">
  ...
  @error('price') <p style="color: red;"></p> @enderror
</div>
