            ...
            <form method="POST" action="{{ route('login') }}"> 
              ...
              <div class="row mb-0 d-flex justify-content-center">
                <div class="col-sm-5 row">
                  <div class="col-md-6">
                    <button type="submit" class="btn btn-primary text-center" style="width: 100%;min-height: 40px;">
                      {{ __('Login') }}
                    </button>
                  </div>
                  <div class="col-md-6">
                    <a href="/redirect/github" class="btn btn-dark text-center" style="width: 100%;min-height: 40px;">
